...
| 双击 | 人类角色=打招呼（挥手）；猫=摸摸头，冒爱心；宝可梦=打招呼（叫声） |
| 右键 | 菜单贴着宠物头顶弹出（可微盖）：人类=打招呼 / 送礼物（开心跳+爱心）/ 聊聊天；猫=喂食 / 摸摸头；宝可梦=打招呼 / 喂个树果（🍓）；打盹·叫醒 / 换角色 / 退出 |
...
- 无聊时随机碎碎念（头顶半透明气泡，自动换行；宝可梦不说话，只会随机来一段专属动作+叫声）
- 发呆时有呼吸微动；深夜（23 点～次日 7 点）自动打盹冒 Zzz（图集角色会播蜷睡姿势）
- 宝可梦空闲时会随机触发**符合设定的专属动作**（皮卡丘放电/电光一闪⚡、
  伊布摇尾巴/好奇歪头、谢米花朵摇曳/草地打滚🌸、比克提尼胜利 V/喷小火苗🔥、
  新叶喵草叶飞舞/蹭脸理毛🍃），配叫声气泡和特效粒子
- 被拖到半空松手会自由落体，落地弹一下
...
| --- | --- |
| 🐱 橘猫 | 程序化绘制的初始角色 |
| 🐾 皮卡丘、伊布、谢米（陆上形态）、比克提尼、新叶喵 | Q 版宝可梦图集（NoobAI 蓝幕/绿幕流程 + 专属随机动作） |

> 本分支（`pokemon`）只含宝可梦；之前的人物角色（少女/竹兰/芒果）
> 在 `hatch-pet` 分支，`git checkout hatch-pet` 切换。
